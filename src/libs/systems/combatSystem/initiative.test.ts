...
vi.mock('libs/systems/rollSystem/roll', async () => {
    const actual = await vi.importActual<typeof import('libs/systems/rollSystem/roll')>
        ('libs/systems/rollSystem/roll')
...
const roll = (await import('libs/systems/rollSystem/roll')).default as ReturnType<typeof vi.fn>
